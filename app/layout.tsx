...
export const metadata: Metadata = {
  title: {
    default: 'Demo FigmaStarterKit OSS - Next.js AI Starter Kit Demo',
    template: '%s | FigmaStarterKit OSS Demo',
  },
  description:
    'Demo website of FigmaStarterKit OSS boilerplate. Built using Next.js, Tailwind CSS, Drizzle ORM, and PostgreSQL.',
};
